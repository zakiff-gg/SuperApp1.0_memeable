...
class MainActivity : ComponentActivity() {
    ...
    private val memeModePref = mutableStateOf(false)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        memeModePref.value = com.sirlasirliputeri.absenssp.util.PrefsHelper.isMemeMode(applicationContext)
                    ...
                    Surface(modifier = Modifier.fillMaxSize()) {
                        ...
                        when (currentScreen.value) {
                            Screen.STANDBY -> StandbyScreen(
                                ...
                                memeMode = memeModePref.value,
                                onToggleMemeMode = {
                                    val baru = !memeModePref.value
                                    memeModePref.value = baru
                                    com.sirlasirliputeri.absenssp.util.PrefsHelper.setMemeMode(applicationContext, baru)
                                }
                            )
